...
# Below is what their code looks like so far:
# Then Alan has asked them to incorporate a new type of vehicle into their system - a Catamaran
...
class WheeledVehicle
  ...
  def inflate_tires(tire_index, pressure)
